...
window.onload = function init()
{
    ...
    circleCenterLocation = gl.getUniformLocation(program, "u_circleCenter");
    circleRadiusLocation = gl.getUniformLocation(program, "u_circleRadius")
    
    gl.uniform2fv(circleCenterLocation, [0.0, 0.0]);
    gl.uniform1f(circleRadiusLocation, 0.5);
