...
window.onload = function init() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "view"), changeView );
    ...
    document.getElementById("blinn").onclick = function(){
      changeView = 1.0;
      document.getElementById("which").innerHTML = 'Blinn-Phong';
      init();
    };
    document.getElementById("phong").onclick = function(){
      changeView = 0.0;
      document.getElementById("which").innerHTML = 'Phong';
      init();
    };
